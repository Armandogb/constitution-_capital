<?php
	...
	function add_custom_home(){
		$labels = array(
			'name'                  => _x( 'Home Page', 'Post Type General Name', 'text_domain' ),
			'singular_name'         => _x( 'Home Page', 'Post Type Singular Name', 'text_domain' ),
			'menu_name'             => __( 'Home Page', 'text_domain' ),
			'name_admin_bar'        => __( 'Home Page', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Home Page', 'text_domain' ),
			'description'           => __( 'Home Page Description', 'text_domain' ),
			'labels'                => $labels,
